"""
Análisis individual de una MH + Binary-Complex (estrategia A9).
Ejecuta 1 corrida, muestra métricas DTW por iteración, genera plot para paper.

Uso (desde la raíz del proyecto):
    python -m binary_complex.run
"""
...
def plot_paper(res: dict, inst: dict, save_dir: str = "results/binary_complex"):
    """
    ...
    ax1.set_title(
        f"{mh_name} + DTW Binary-Complex — Convergence (seed={res.get('semilla', '?')})"
    )
