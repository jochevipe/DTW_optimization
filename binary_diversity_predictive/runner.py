"""
Runner para Binary-Diversity-Predictive (estrategia A10).
Wrapper sobre el runner genérico con fire_fn = DiversityPredictiveController.

El controlador es stateful, así que cada época recibe una instancia fresca
vía fire_fn_factory; el runner genérico invoca fire_fn.bind(mh) una sola vez
tras initialize() para darle acceso a la población.
"""
...
def run_experiment(**kwargs):
    """run_experiment con estrategia A10 (diversidad + predictivo)."""
...
def run_epochs(**kwargs):
    """run_epochs con estrategia A10 (diversidad + predictivo)."""
