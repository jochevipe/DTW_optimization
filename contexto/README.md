...
| [`params_instancias/instancias_mkp.md`](params_instancias/instancias_mkp.md) | Tabla descriptiva de los archivos Chu–Beasley; usá [`odd/tasks/02_frente2-multi-instancia.md`](../odd/tasks/02_frente2-multi-instancia.md) para los índices oficiales de la próxima campaña. |
...
Para la secuencia de tareas y decisiones de esta limpieza, consultá [`odd/tasks/04_post-merge-cleanup.md`](../odd/tasks/04_post-merge-cleanup.md).
