"""
Binary-Hysteresis (A9) config — stateful explore/exploit switch built on the
...
explore, making Binary-Hysteresis bit-identical to vanilla_exploracion in
every comparison of the 2026-08-22 campaign.
